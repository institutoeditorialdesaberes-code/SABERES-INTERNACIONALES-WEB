...
const TRAZOS = {
  ...
  telegram: `<path d="m22 3-9.5 9.5M22 3 15 21l-3.5-7.5L4 10z" ${T}/>`,
  enlace: `<path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" ${T}/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" ${T}/>`,
